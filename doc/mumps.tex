...
The resurgence of mumps outbreaks in the US continues to raise questions about the need for third dose of the MMR vaccine, but existing estimates on the third-dose vaccine effectiveness are still limited.
Here, we analyzed mumps outbreak that occurred at the University of Iowa between August 24, 2015 and May 13, 2016, using mathematical modeling approach, which allowed us to account for different sources of biases. 
We estimate that school holidays likely had a greater impact on preventing mumps transmission than vaccination.
